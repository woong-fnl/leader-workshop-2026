...
const EVENT = {
  ...
  // ── 자리배치도 ─────────────────────────────────────────────
  // images/ 폴더에 이미지 파일을 넣고 파일명을 입력하세요 (예: "seating-chart.png")
  seatingChart: { image: "" },
  ...
  attendees: [
    ...
    { name: "강수지", title: "CSO",           division: "CEO Direct",            team: "CEO Staff",                phone: "010-2614-0738" },
  ...
  accommodation: {
    ...
    // 와이파이
    wifi: [
      { ssid: "(공유기에서 확인)", password: "a11223344", note: "SSID(네트워크 이름)는 현장 공유기 스티커에서 확인해 주세요." },
    ],
  ...
  days: [
    {
      ...
      isoDate: "2026-07-09",
      items: [
        { time:"09:15 – 09:30", title:"집합",                         desc:"",                                                                                                                                                                                                                                                              note:"",                            location:"생각공장 당산 미팅룸 E",   locationUrl:"https://map.naver.com/v5/search/%EC%83%9D%EA%B0%81%EA%B3%B5%EC%9E%A5%20%EB%8B%B9%EC%82%B0", type:"session" },
        ...
        { time:"15:30 – 16:10", title:"Session 1 — 회사 방향성 및 인사체계 Sync", desc:"① 사업계획 수립: 일정 및 목적 공유\n② 인사체계 안내: 직무, Job Level, 직책, 평가, 보상 기준 등\n③ 타운홀 안내: 리더들이 먼저 인지해야 할 타운홀 미팅 가이드",                                                                              note:"대형세미나실",             location:"포유포레",                locationUrl:"https://map.naver.com/v5/search/%ED%8F%AC%EC%9C%A0%ED%8F%AC%EB%A0%88",                           type:"keynote" },
        { time:"16:10 – 16:30", title:"휴식 시간",                    desc:"",                                                                                                                                                                                                                                                              note:"",                            location:"",                          locationUrl:"",                                                                                            type:"break" },
        { time:"16:30 – 18:00", title:"Session 2 — 에프앤엘의 문제 마주하기", desc:"① 문화적 문제: 회사가 겪고 있는 소통/협업의 병목 구간 공유\n② 개인의 고충: 팀을 운영하며 겪는 리더들의 현실적인 어려움\n→ 넋두리가 아니라, 함께 해결해야 할 공식 안건으로 인지",                                                              note:"대형세미나실", location:"포유포레",                locationUrl:"https://map.naver.com/v5/search/%ED%8F%AC%EC%9C%A0%ED%8F%AC%EB%A0%88",                           type:"keynote" },
        ...
        { time:"20:30 – 22:00", title:"Session 3 — 안도감 → 영향력", desc:"나만 힘든 게 아니고, 모두가 고충이 있구나… 감정 터치\n그렇다면 리더로서 에프앤엘을 어떻게 바꿀 수 있는가",                                                                                                                                               note:"공용주방", location:"포유포레",               locationUrl:"https://map.naver.com/v5/search/%ED%8F%AC%EC%9C%A0%ED%8F%AC%EB%A0%88",                           type:"keynote" },
      ],
    },
    {
      label: "Day 2",
  ...
  briefing: {
    meetingPoint: {
      ...
      date:        '2026년 7월 9일(목)',
      time:        '09:15',
      note:        '버스 출발 시간(09:30)에 맞춰 09:15까지 도착해 주세요.',
    },
    ...
    checklist: [
      ...
      },
      {
        ...
        sub:   { type: 'info', emoji: '🛁', badge: '안내', text: '수건은 숙소에서 제공됩니다. 여분 수건은 1층 사우나에 있습니다.' },
      },
      {
        emoji: '🕶️',
        title: '선글라스 · 선크림 · 양산',
  ...
  tips: [
    ...
    { keywords:["와이파이","wifi","인터넷","비밀번호","비번"], title:"Wi-Fi 안내", desc:"Wi-Fi 비밀번호는 a11223344입니다. 숙소 탭 → 와이파이 메뉴에서 복사하실 수 있어요." },
    { keywords:["도어록","도어락","현관","출입문","현관문","비밀번호","비번"], title:"도어록 안내", desc:"도어록 비밀번호는 0709입니다. 숙소 탭 → 도어록 메뉴에서 복사하실 수 있어요." },
    { keywords:["버스","교통","셔틀","이동"], title:"교통 안내",    desc:"생각공장 당산(미팅룸 E)에서 버스로 출발합니다. 09:15까지 집합해 주세요." },
    { keywords:["객실","룸","방","숙박","체크인","퇴실","방배정","호실"], title:"숙박 안내", desc:"포유포레 체크인 14:00–14:30, 퇴실 Day 2 10:30–11:00 입니다. 방배정은 숙소 탭 → 방배정 메뉴에서 확인하세요." },
    { keywords:["수건","타월","사우나"],      title:"수건 안내",    desc:"수건은 숙소에서 제공됩니다. 여분 수건은 1층 사우나에 있습니다." },
    { keywords:["조식","아침","아침식사","브런치"], title:"조식 안내", desc:"Day 2 조식은 08:00–09:00, 2층 공용주방에서 자유롭게 드시면 됩니다. 드신 후 뒷정리도 부탁드려요 :)" },
    { keywords:["수영","수영복","풀장","물놀이"], title:"풀장 안내", desc:"숙소 안에 풀장이 준비되어 있어요. 이용하실 분은 수영복을 챙겨주세요. 필수 지참은 아니에요." },
    { keywords:["골프","골프채","스크린골프"], title:"스크린골프 안내", desc:"1층에 스크린골프장이 있어요. 골프채를 가져오시면 법인차량으로 별도로 옮겨드려요. 하우스 채도 있지만 종류가 많지 않아요." },
    { keywords:["선크림","선글라스","양산","자외선","더위"], title:"자외선 대비", desc:"야외 활동 시 자외선이 매우 강해요. 선크림·선글라스·양산을 챙겨주세요. 단, 카트 탑승 시 선글라스는 흠집이 생길 수 있으니 주의하세요." },
    { keywords:["준비물","챙길것","짐"],      title:"준비물 안내",  desc:"편한 복장, 개인 위생도구를 챙겨주세요. 수영복·골프채는 선택이에요. 자세한 내용은 HOME 탭 → 준비물에서 확인하세요." },
    { keywords:["세미나실","세션","회의실"],  title:"세션 장소",    desc:"Session 1·2는 1층 대형세미나실, Session 3은 2층 공용주방에서 진행돼요." },
    { keywords:["만찬","저녁","저녁식사","공용주방","치킨","피자"], title:"만찬 안내", desc:"Day 1 만찬은 18:10–20:30, 2층 공용주방에서 진행돼요. 치킨과 피자, 술과 스낵이 준비되어 있어요." },
    { keywords:["카페","카페만경","쿠폰","음료"], title:"카페만경 안내", desc:"두물머리 산책 후 카페만경으로 집합해 주세요. 이름표 안에 있는 쿠폰으로 시원한 음료를 드실 수 있어요." },
    { keywords:["문의","질문","연락","채널","슬랙"], title:"문의 안내", desc:"사전 문의는 #2026년-leadership-workshop 채널로 부탁드려요." },
  ],
